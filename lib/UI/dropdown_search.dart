...
class DropdownSearchScreen extends StatefulWidget {
  const DropdownSearchScreen({Key? key}) : super(key: key);

  @override
  State<DropdownSearchScreen> createState() => _DropdownSearchScreenState();
}

class _DropdownSearchScreenState extends State<DropdownSearchScreen> {
